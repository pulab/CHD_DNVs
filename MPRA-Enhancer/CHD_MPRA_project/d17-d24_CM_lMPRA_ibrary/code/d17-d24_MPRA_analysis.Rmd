...
print(formatted_p_values)
#p<-pairwise.wilcox.test(filter_norm_data_scaled_for_plot$mean_log_ratio, filter_norm_data_scaled_for_plot$group4, p.adjust.method = "bonferroni")
#p_values <- p$p.value
...
#library(AICcmodavg)  
#options(scipen = 999)
#filter_norm_data_scaled_for_plot$value <- as.numeric(filter_norm_data_scaled_for_plot$mean_log_ratio)
#one.way <- aov(value ~ group4, data = filter_norm_data_scaled_for_plot)
